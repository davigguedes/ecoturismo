document.addEventListener("DOMContentLoaded", function () {
    ...
    // Lista de gradientes para cada item
    let gradients = [
      "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(9,9,121,1) 24%, rgba(0,212,255,1) 100%)", // Gradiente 1
      "linear-gradient(90deg, rgba(11,105,13,1) 0%, rgba(15,148,15,1) 34%, rgba(72,249,1,1) 100%)", // Gradiente 2 (Corrigido)
    ...
    function showItem(index) {
      ...
      // Aplicando o gradiente no background da seção .ods
